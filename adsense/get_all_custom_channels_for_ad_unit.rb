...
def get_all_custom_channels_for_ad_unit(adsense, account_id, ad_client_id,
                                        ad_unit_id)

  request = adsense.accounts.adunits.customchannels.list(
...
if __FILE__ == $0
  ...
  get_all_custom_channels_for_ad_unit(
    adsense, account_id, ad_client_id, ad_unit_id)
end
