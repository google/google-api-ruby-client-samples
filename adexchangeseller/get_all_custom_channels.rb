...
def get_all_custom_channels(adexchangeseller, ad_client_id)
  request = adexchangeseller.customchannels.list(:adClientId => ad_client_id,
...
if __FILE__ == $0
  ...
  get_all_custom_channels(adexchangeseller, ad_client_id)
end
