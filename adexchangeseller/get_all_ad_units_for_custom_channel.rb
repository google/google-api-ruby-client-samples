...
def get_all_ad_units(adexchangeseller, account_id, ad_client_id,
                     custom_channel_id)
  request = adexchangeseller.accounts.customchannels.adunits.list(
...
if __FILE__ == $0
  ...
  get_all_ad_units(adexchangeseller, account_id, ad_client_id,
                   custom_channel_id)
end
